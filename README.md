...
> ⚠️ **Projet Supabase partagé avec le CRM** : toutes les tables de cette app sont préfixées `qualite_` (ex: `qualite_dossiers`, `qualite_profiles`) pour ne jamais entrer en collision avec les tables du CRM sur le même projet Supabase.
